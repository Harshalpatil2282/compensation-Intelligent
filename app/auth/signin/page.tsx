...
// Sign-in page with GitHub and Google OAuth
...
export const metadata: Metadata = {
  title: 'Sign In',
  description: 'Sign in to CompIntel',
}
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 left-1/3 w-96 h-96 bg-indigo-600/15 rounded-full blur-3xl" />
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Welcome to CompIntel</h1>
          <p className="text-slate-400 text-sm mt-2">
            Sign in to submit and manage your compensation data
          </p>
        </div>
